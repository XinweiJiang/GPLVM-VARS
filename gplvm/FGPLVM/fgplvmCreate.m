...
if isfield(options, 'NoOptHyper') & ~isempty(options.NoOptHyper)
    model.NoOptHyper = options.NoOptHyper;
    model.OptHyper = options.OptHyper;
end

if isfield(options, 'oriX_NoLastOne') & ~isempty(options.oriX_NoLastOne)
    model.oriX_NoLastOne = options.oriX_NoLastOne;
end
