...
%
%	Description:
%	% 	demRobotWirelessNavigate.m CVS version 1.4
% 	demRobotWirelessNavigate.m SVN version 29
% 	last update 2007-11-03T14:33:22.000000Z
...
load(['dem' capName 'Fgplvm' num2str(experimentNo) '.mat']);
