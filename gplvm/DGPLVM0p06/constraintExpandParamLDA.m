function model = constraintExpandParamLDA(model,X)

% CONSTRAINTEXPANDPARAMLDA Expands a LDA constraint model
%
%	Description:
%
%	MODEL = CONSTRAINTEXPANDPARAMLDA(MODEL, X) Returns expanded model
%	 Returns:
%	  MODEL - Returns expanded model
%	 Arguments:
...
%
%	See also
%	CONSTRAINTEXPANDPARAM


%	Copyright (c) 2009 Carl Henrik Ek
% 	constraintExpandParamLDA.m SVN version 295
